                    ...
                    animated:(__unused BOOL)animated
{
  ...
  [tc animateAlongsideTransition: ^(id<UIViewControllerTransitionCoordinatorContext> context) {
    RCTWrapperViewControllerWithNavItem *fromController =
      (RCTWrapperViewControllerWithNavItem *)[context viewControllerForKey:UITransitionContextFromViewControllerKey];
    RCTWrapperViewControllerWithNavItem *toController =
      (RCTWrapperViewControllerWithNavItem *)[context viewControllerForKey:UITransitionContextToViewControllerKey];
...
BOOL jsGettingtooSlow =
  ...
  if (jsGettingAhead) {
    if (reactPushOne) {
      ...
      RCTWrapperViewControllerWithNavItem *vc = [[RCTWrapperViewControllerWithNavItem alloc] initWithNavItem:(RCTNavItem *)lastView];
